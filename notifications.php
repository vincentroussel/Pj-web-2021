...
<body>
	<div class="container-fluid">
		<div class="row; text-white bg-info">
			<h1 class="text-center">Bienvenue sur votre espace notifications de l'ECE MarketPlace <img src="ecemarketplace.jpg"></h1>
		</div>
		<div class="row; text-white bg-info">
  ...
  <br>
  <br>
  <li><a href="setnotifications.html"> Choisir mes paramètres de notifications</a></li>
  <br>
  <br>
  <form action="recuperernotifications.php" method="POST">
    <tr>
      <td colspan="2" align="center">
        <input type="submit" value="afficher mes notifications" >
      </td>
    </tr>
  </form>
  <p>Vos notifications:</p><br>
  <?php
    if ($_SESSION['ouinonglobal']=='non'){
      ?>
      <p>Vous avez choisi de ne pas avoir de notifications</p><br>
      <?php
    }
    else{
  ...
  <div>
      <?php
        $length=count($_SESSION['listenotifications']);
        $listeobjet  = $_SESSION['listenotifications'];
        for($i=0;$i< $length;$i++){
        ?>
    </div>
