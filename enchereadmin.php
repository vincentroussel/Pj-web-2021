...
<body>
	<div class="container-fluid">
        <div class="row; text-white bg-info">
            <h1 class="text-center">Bienvenue sur la page d'enchères admin de l'ECE MarketPlace <img src="ecemarketplace.jpg"></h1>
        </div>
        <div class="row; text-white bg-info">
		...
		<li class="active"><a href="enchereadmin.php">Enchères</a></li>
