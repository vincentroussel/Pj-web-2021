<?php
    ...
    if ($db_found) {
        ...
        $sql="UPDATE negociation SET prixacheteur = $votreoffre WHERE ID=$IDnego";
        $result = mysqli_query($db_handle, $sql);
        $sql="SELECT prixvendeur FROM negociation WHERE ID=$IDnego";
        $result = mysqli_query($db_handle, $sql);
        while ($data = mysqli_fetch_assoc($result)) {
            $offrevendeur=intval($data['prixvendeur']);
        }
