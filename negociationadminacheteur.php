...
<html lang="en">
<head>
	<title>Bienvenue sur la page négociations administrateur/acheteur de l'ECE MarketPlace</title>
	<meta charset="utf-8">
...
<body>
  <div class="container-fluid">
    <div class="row; text-white bg-info">
      <h1 class="text-center">Bienvenue sur la page des négociations administrateur/acheteur de l'ECE MarketPlace <img src="ecemarketplace.jpg"></h1>
    </div>
    <div class="row; text-white bg-info">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right navbar-expand">
              <li class="active"><a href="negociationadminacheteur.html">Négociations</a></li>
    ...
    <form action="affichernegoadminacheteur.php" method="POST">
            <tr>
    ...
    <?php }
        ?>
    <form action="traitementnegociationadminacheteur.php" method="POST">
        <table>
            <tr>
                <td>Votre offre:</td>
